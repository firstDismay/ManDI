...
{
    /// <summary>
    /// Команда возвращает список данных значения пользовательского свойства типа SMALL по идентификатору свойства
    /// </summary>
    public class position_prop_user_small_val_by_id_prop : IParametersFunction
    {
        /// <summary>
