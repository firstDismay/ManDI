...
{
    /// <summary>
    /// Команда обновляет значение в виде идентификатора экземпляра сущности для свойства позициии типа ссылка
    /// </summary>
    public class position_prop_link_val_upd : IParametersFunction
    {
        /// <summary>
        ...
        public string NameFunction
        {
            get
            {
                return "position_prop_link_val_upd";
            }
        }
    }
}
