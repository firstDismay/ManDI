...
{
    /// <summary>
    /// Команда возвращает список позиций по идентификатору перечисления
    /// </summary>
    public class position_by_id_prop_enum : IParametersFunction
    {
        /// <summary>
        ...
        public string NameFunction
        {
            get
            {
                return "position_by_id_prop_enum";
            }
        }
