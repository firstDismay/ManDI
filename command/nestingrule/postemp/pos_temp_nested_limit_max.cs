...
{
    /// <summary>
    /// Команда возвращает максимально допустимое количество позиций определенного шаблона, вложенных в указанную позицию, 0-нет ограничений
    /// </summary>
    public class pos_temp_nested_limit_max : IParametersFunction
    {
        /// <summary>
