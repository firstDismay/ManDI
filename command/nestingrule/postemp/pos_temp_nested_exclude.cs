...
{
    /// <summary>
    /// Команда исключает шаблон из перечня доступных к вложению шаблонов
    /// </summary>
    public class pos_temp_nested_exclude : IParametersFunction
    {
        /// <summary>
        ...
        public string NameFunction
        {
            get
            {
                return "pos_temp_nested_exclude";
            }
        }
