...
{
    /// <summary>
    /// Команда удаляет назначение уровня L1 типа класс на шаблон
    /// </summary>
    public class rulel1_class_on_pos_temp_del : IParametersFunction
    {
        /// <summary>
        ...
        public string NameFunction
        {
            get
            {
                return "rulel1_class_on_pos_temp_del";
            }
        }
