...
{
    /// <summary>
    /// Команда определяет наличие разрешения уровня L1 типа класс на шаблон по идентификаторам шаблона и класса
    /// </summary>
    public class rulel1_class_on_pos_temp_check_access : IParametersFunction
    {
        /// <summary>
        ...
        public string NameFunction
        {
            get
            {
                return "rulel1_class_on_pos_temp_check_access";
            }
        }
    }
}