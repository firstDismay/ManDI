...
{
    /// <summary>
    /// Команда возвращает правило назначения уровня L1 типа группа на шаблон по идентификатору группы и шаблона
    /// </summary>
    public class rulel1_group_on_pos_temp_by_id : IParametersFunction
    {
        /// <summary>
        ...
        public string NameFunction
        {
            get
            {
                return "rulel1_group_on_pos_temp_by_id";
            }
        }
    }
}