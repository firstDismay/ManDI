...
{
    /// <summary>
    /// Команда возвращает список правил назначения уровня L1 типа группа на шаблон по идентификатору шаблона
    /// </summary>
    public class rulel1_group_on_pos_temp_by_id_pos_temp : IParametersFunction
    {
        /// <summary>
