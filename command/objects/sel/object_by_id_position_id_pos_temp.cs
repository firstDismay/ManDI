...
{
    /// <summary>
    /// Команда возвращает список объектов позиций указанного шаблона рекурсивно начиная с указанной позиции
    /// </summary>
    public class object_by_id_position_id_pos_temp : IParametersFunction
    {
        /// <summary>
