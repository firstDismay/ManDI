...
{
    /// <summary>
    /// Команда обновляет данные большого значения пользовательского свойства объектам снимка класса в указанной позиции
    /// </summary>
    public class object_prop_user_big_val_objects_upd : IParametersFunction
    {
        /// <summary>
        ...
        public string NameFunction
        {
            get
            {
                return "object_prop_user_big_val_objects_upd";
            }
        }
    }
}