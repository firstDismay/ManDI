...
{
    /// <summary>
    /// Команда удаляет значение свойств типа ссылка объекта объектов снимка класса в указанной позиции
    /// </summary>
    public class object_prop_link_val_objects_del : IParametersFunction
    {
        /// <summary>
        ...
        public string NameFunction
        {
            get
            {
                return "object_prop_link_val_objects_del";
            }
        }
