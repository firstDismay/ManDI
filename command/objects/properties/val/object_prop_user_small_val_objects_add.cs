...
{
    /// <summary>
    /// Команда добавляет малое значение пользовательского свойства класса объектам снимка класса в указанной позиции
    /// </summary>
    public class object_prop_user_small_val_objects_add : IParametersFunction
    {
        /// <summary>
