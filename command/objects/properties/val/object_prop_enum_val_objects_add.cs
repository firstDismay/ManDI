...
{
    /// <summary>
    /// Команда добавляет значение в виде элемента перечисления для свойства типа перечисление 
    /// объектов снимка класса в указанной позиции
    /// </summary>
    public class object_prop_enum_val_objects_add : IParametersFunction
    {
        /// <summary>
        ...
        public string NameFunction
        {
            get
            {
                return "object_prop_enum_val_objects_add";
            }
        }
    }
}