...
{
    /// <summary>
    /// Команда добавляет значение в виде идентификатора экземпляра сущности для свойств 
    /// типа ссылка объектов снимка класса в указанной позиции
    /// </summary>
    public class object_prop_link_val_objects_add : IParametersFunction
    {
        /// <summary>
        ...
        public string NameFunction
        {
            get
            {
                return "object_prop_link_val_objects_add";
            }
        }
