...
{
    /// <summary>
    /// Команда возвращает значение свойства объекта типа перечисление по идентификатору свойства
    /// </summary>
    public class object_prop_enum_val_by_id_prop : IParametersFunction
    {
        /// <summary>
