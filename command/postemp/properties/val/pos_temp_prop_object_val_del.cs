...
{
    /// <summary>
    /// Команда удаляет данные значения объектного свойства шаблона позиции по идентификатору свойства шаблока позиции
    /// </summary>
    public class pos_temp_prop_object_val_del : IParametersFunction
    {
        /// <summary>
