...
{
    /// <summary>
    /// Команда обновляет значение в виде ссылки на сущность для свойства класса типа ссылка
    /// </summary>
    public class class_prop_link_val_upd : IParametersFunction
    {
        /// <summary>
        ...
        public string NameFunction
        {
            get
            {
                return "class_prop_link_val_upd";
            }
        }
    }
}