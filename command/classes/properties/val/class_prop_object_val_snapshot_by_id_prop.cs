...
{
    /// <summary>
    /// Команда возвращает данные значения объектного свойства для исторического представления класса по идентификатору свойства
    public class class_prop_object_val_snapshot_by_id_prop : IParametersFunction
    {
        /// <summary>
