...
{
    /// <summary>
    /// Команда возвращает данные большого значения пользовательского свойства для свойства исторического представления класса
    /// </summary>
    public class class_prop_user_big_val_snapshot_by_id_prop : IParametersFunction
    {
        /// <summary>
