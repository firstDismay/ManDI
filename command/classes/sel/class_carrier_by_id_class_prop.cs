...
{
    /// <summary>
    /// Команда возвращает активное/историческое представление класса носителя по идентификатору свойства
    /// </summary>
    public class class_carrier_by_id_class_prop : IParametersFunction
    {
        /// <summary>
