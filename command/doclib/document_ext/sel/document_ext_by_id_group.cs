...
{
    /// <summary>
    /// Команда возвращает расширенные документы  по идентификатору группы
    public class document_ext_by_id_group : IParametersFunction
    {
        /// <summary>
        ...
        public string NameFunction
        {
            get
            {
                return "document_ext_by_id_group";
            }
        }
    }
}