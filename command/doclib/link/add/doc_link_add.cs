...
namespace ManDI.command.doclib.link.add
{
    /// <summary>
    /// Команда добавляет ссылки на сущность для документа библиотеки документов
    public class doc_link_add : IParametersFunction
    {
        /// <summary>
