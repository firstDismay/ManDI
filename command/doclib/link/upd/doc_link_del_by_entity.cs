...
namespace ManDI.command.doclib.link.upd
{
    /// <summary>
    /// Команда удаляет ссылку документа на сущность БД по идентификатору сущности
    public class doc_link_del_by_entity : IParametersFunction
    {
        /// <summary>
