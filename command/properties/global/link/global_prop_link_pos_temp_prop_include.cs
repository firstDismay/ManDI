...
{
    /// <summary>
    /// Команда добавляет ссылку глобального свойства на свойство шаблона позиции
    /// </summary>
    public class global_prop_link_pos_temp_prop_include : IParametersFunction
    {
        /// <summary>
        ...
        public string NameFunction
        {
            get
            {
                return "global_prop_link_pos_temp_prop_include";
            }
        }
    }
}