...
{
    /// <summary>
    /// Команда Функция исключает ссылку глобального свойства на свойство шаблона позиции
    /// </summary>
    public class global_prop_link_pos_temp_prop_exclude : IParametersFunction
    {
        /// <summary>
