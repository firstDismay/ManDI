...
{
    /// <summary>
    /// Команда добавляет ссылку глобального свойства на определяющее свойства класса
    /// </summary>
    public class global_prop_link_class_prop_include : IParametersFunction
    {
        /// <summary>
        ...
        public string NameFunction
        {
            get
            {
                return "global_prop_link_class_prop_include";
            }
        }
