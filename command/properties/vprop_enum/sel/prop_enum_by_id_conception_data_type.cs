...
{
    /// <summary>
    /// Команда возвращает список перечислений по идентификаторам концепции и типа данных свойства
    /// </summary>
    public class prop_enum_by_id_conception_data_type : IParametersFunction
    {
        /// <summary>
        ...
        public string NameFunction
        {
            get
            {
                return "prop_enum_by_id_conception_data_type";
            }
        }
