...
{
    /// <summary>
    /// Команда возвращает список перечислений применимых для позиций по идентификаторам концепции и типа данных
    /// </summary>
    public class prop_enum_for_position_by_id_conception_data_type : IParametersFunction
    {
        /// <summary>
