...
{
    /// <summary>
    /// Команда перемещает элемент перечисления на одну позицию вниз в списке элементов
    /// </summary>
    public class prop_enum_val_sort_down : IParametersFunction
    {
        /// <summary>
        ...
        public string NameFunction
        {
            get
            {
                return "prop_enum_val_sort_down";
            }
        }
    }
}