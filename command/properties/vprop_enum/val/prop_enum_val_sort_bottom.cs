...
{
    /// <summary>
    /// Команда перемещает элемент перечисления в конец списка элементов
    /// </summary>
    public class prop_enum_val_sort_bottom : IParametersFunction
    {
        /// <summary>
        ...
        public string NameFunction
        {
            get
            {
                return "prop_enum_val_sort_bottom";
            }
        }
    }
}