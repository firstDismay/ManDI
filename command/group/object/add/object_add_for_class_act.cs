...
{
    /// <summary>
    /// Команда создает объекты вещественных классов по идентификаторам позиции и класса в количестве одной базовой единицы
    /// </summary>
    public class object_add_for_class_act : IParametersFunction
    {
        /// <summary>
        ...
        public string NameFunction
        {
            get
            {
                return "object_add_for_class_act";
            }
        }
    }
}
